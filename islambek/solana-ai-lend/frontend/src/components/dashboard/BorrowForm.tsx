...
export default function BorrowForm({
  ...
  return (
    <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
      <h3 className="text-sm font-medium text-gray-400 mb-3">Borrow aiUSDC</h3>
      ...
      <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-2"} gap-4 mb-3`}>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-600">{usedPct.toFixed(1)}% of borrow capacity used</p>
        </div>
